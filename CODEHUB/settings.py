...
# ALLOWED_HOSTS for Render, Vercel, and Local
...
INSTALLED_APPS = [
    ...
    'whitenoise.runserver_nostatic', # Static files enhancement
...
MIDDLEWARE = [
    ...
    'whitenoise.middleware.WhiteNoiseMiddleware', # WhiteNoise must be above others
...
# Use WhiteNoise for efficient static file serving and compression
STORAGES = {
    "default": {
...
# CSRF Trusted Origins (Required for Admin/POST requests in production)
